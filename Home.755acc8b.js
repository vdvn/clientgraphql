...
var _default = function _default(_ref) {
  var loadingUsers = _ref.loadingUsers,
      allPhotos = _ref.allPhotos;
  return (0, _hyperapp.h)("div", null, loadingUsers ? (0, _hyperapp.h)("p", null, "loading photos...") : (0, _hyperapp.h)(PhotosList, {
    photos: allPhotos
  }));
};
...
var PhotosList = function PhotosList(_ref2) {
  var photos = _ref2.photos;
  return photos.map(function (photo) {
    return (0, _hyperapp.h)("img", {
      key: photo.id,
      src: _effects.url + photo.url,
      alt: photo.name,
      width: 350
    });
  });
};
},{"hyperapp":"../node_modules/hyperapp/src/index.js","./effects":"effects.js"}],"Home.js":[function(require,module,exports) {
"use strict";
...
var _default = function _default(state) {
  return (0, _hyperapp.h)("div", null, (0, _hyperapp.h)(_ErrorDisplay.default, {
    ...
    auth: state.auth
  }), (0, _hyperapp.h)(_Users.default, {
    totalUsers: state.totalUsers,
    allUsers: state.allUsers,
    loadingUsers: state.loadingUsers
  }), (0, _hyperapp.h)(_Photos.default, {
